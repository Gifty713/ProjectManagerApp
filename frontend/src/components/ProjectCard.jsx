...
export default function ProjectCard({ project, who, currentWorkspace, setCurrentWorkspace, currentProject, setCurrentProject }) {
  ...
  const isCurrentProject = currentProject === id
      ...
      {who === "projects" ? (
        <div className="project-card card">
          ...
          <div className="project-card-foot">
            ...
            <button type="button" className="project-view" onClick={projectClick}>
              {isCurrentProject ? "Current project" : "Switch to project"}
            </button>
            <Link to={`/projects/${id}`} className="project-view" onClick={projectClick}>View project →</Link>
          </div>
        </div>
      ) : (
        <div className="project-card card" onClick={wsClick}>
          ...
          <div className="project-card-foot">
            <span className="workspace-view">
              {isCurrentWorkspace ? "Current workspace" : "Switch to workspace"}
            </span>
          </div>
        </div>
      )}
